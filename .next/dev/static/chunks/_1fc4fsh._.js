...
"[project]/lib/default-rules.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/rule-engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const parseTable = (sheets, rule)=>{
    ...
    for (const sheet of selected){
        ...
        for (const row of sheet.rows.slice(dataStart)){
            ...
            for (const field of __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderFields"]){
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$default$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/default-rules.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rule$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/rule-engine.ts [app-client] (ecmascript)");
;
...
function Page() {
    ...
    const [toast, setToast] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("等待上传文件");
    ...
    const [previewLimit, setPreviewLimit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(300);
    ...
    const existingCodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Page.useMemo[existingCodes]": ()=>new Set(history.map({
                "Page.useMemo[existingCodes]": (row)=>row.externalCode
            }["Page.useMemo[existingCodes]"]).filter(Boolean))
    }["Page.useMemo[existingCodes]"], [
        history
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
            ...
            fetch("/api/rules").then({
                ...
                "Page.useEffect": ()=>setTimedToast("规则加载失败，已使用默认规则")
            }["Page.useEffect"]);
    ...
    const readFile = async (file)=>{
        ...
        try {
            ...
            if (lower.endsWith(".xlsx") || lower.endsWith(".xls")) {
                const XLSX = await __turbopack_context__.A("[project]/node_modules/@e965/xlsx/xlsx.mjs [app-client] (ecmascript, async loader)");
                ...
                const mammoth = await __turbopack_context__.A("[project]/node_modules/mammoth/mammoth.browser.js [app-client] (ecmascript, async loader)");
    ...
    const deleteRule = async ()=>{
        ...
        const nextRules = data.rules;
        setRules(nextRules);
        setSelectedRuleId(nextRules[0]?.id ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$default$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultRules"][0].id);
        setTimedToast(`规则已删除，存储模式：${data.mode}`);
    };
    const runParse = ()=>{
        if (!sheets.length) return setTimedToast("请先上传文件");
        const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rule$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseByRule"])(sheets, selectedRule);
        const nextIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rule$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateRows"])(parsed, existingCodes);
        setPreviewLimit(300);
    ...
    const updateCell = (id, field, value)=>{
        ...
        const nextIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rule$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateRows"])(nextRows, existingCodes);
    ...
    const exportExcel = async ()=>{
        const ExcelJS = await __turbopack_context__.A("[project]/node_modules/exceljs/dist/exceljs.min.js [app-client] (ecmascript, async loader)");
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: sheets.map((sheet)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                sheet.name,
                                                " · ",
                                                sheet.rows.length,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: rules.map((rule)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: rule.id,
                                            children: rule.name
                                        }, rule.id, false, {
                                            fileName: "[project]/app/page.tsx",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            onClick: ()=>setRuleText(JSON.stringify({
                                                    ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$default$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultRules"][0],
                                                    id: crypto.randomUUID(),
                                                    name: "新建规则"
                                                }, null, 2)),
                                            children: [
                    ...
                    children: [
                        ...
                        issues.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                issues.map((issue)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: [
                                            "第 ",
                                            issue.rowNumber,
                                            " 行 · ",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            children: [
                                                ...
                                                fields.map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        children: visibleRows.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    ...
                                                    fields.map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "history",
                            children: [
                                pagedHistory.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                ...
                                !filteredHistory.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "empty",
                                    children: "暂无历史记录"
                                }, void 0, false, {
                                    fileName: "[project]/app/page.tsx",
...
_s(Page, "4h3bepN0Ab2GspCiVvwA3vkn+tg=");
_c = Page;
var _c;
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/createLucideIcon.js [app-client] (ecmascript)");
;
const FileUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("FileUp", [
    [
        "path",
        {
...
//# sourceMappingURL=_1fc4fsh._.js.map